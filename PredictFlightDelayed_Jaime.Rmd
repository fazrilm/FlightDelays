...
Gather and clean data: We gather data from Kaggle and reduce the number of rows. Originaly the filed had more than one million rows, including all airlines during 2008. We decided to reduce the scope to American Airlines and the month of January. By selecting only one month we reduce seasonality on the data
