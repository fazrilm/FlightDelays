...
<br>Gather and clean data: We gather data from Kaggle and reduce the number of rows. Originaly the filed had more than one million rows, including all airlines during 2008. We decided to reduce the scope to American Airlines and the month of January. By selecting only one month we reduce seasonality on the data
<br>Analyze data: We looked for variables that made business sense and were independent and relevant for our statistical analysis
<br>Business recommendation: We selected number of factors that would allow us to create a sound business recommendation to AA. The criteria to create a recommendation is to identify practical implementation steps to improve operation
...
1. Airline Operation
     Flight delays are caused by the distance / air time of the specific flights
...
2. Airport Operation
    Flight delays are caused by mismanagement of airport operators
Recommendation: Revise contracts with airport operators to get priority on landing/departing

3. God
    Flight delays are caused by uncontrollable factors – i.e. the weather
