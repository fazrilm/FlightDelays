...
<br>- Gather and clean data: We gather data from Kaggle and reduced the number of rows. Originaly the files had more than one million rows, including all airlines during 2008. We decided to reduce the scope to American Airlines and the month of January. By selecting only one month we also reduced seasonality on the data.
